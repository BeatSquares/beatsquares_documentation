...
<Update label="Version 1.0.0 - Major Release" description="Released November 26, 2025">
...
- **Scheduled Scraping**: Added Tagesspiegel scrapers to scheduled scraping tasks for automated content collection
...
- **Tagesspiegel RSS Integration**: Added support for importing Tagesspiegel articles from full-text RSS feed with Media RSS support
...
- **Bezirksnewsletter Sources**: Added Berlin-specific scrapers for events and press releases from various Berlin government sources
