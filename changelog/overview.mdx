...
<Update label="Version 1.24.0 - Introduce static segment type for" description="Released May 11, 2026">
...
- **Fix E2E strategy-builder compatibility and stabilize CI test runs**: Enhance the reliability of strategy-building tools and testing processes.

**Other Changes**

- Terraform changes for WAHA (added secrets, disabled autoscaling for waha and worker): Improve system configuration and performance.
- Fix wrong postgres DB configuration: Correct database settings for smoother operation.

</Update>

<Update label="Version 1.23.0 - Migrate podcast dialog to structure..." description="Released May 6, 2026">

**New Features**

- **Migrate podcast dialog to structured_data as the single source of truth**: Ensure all podcast information is consistent and centralized.
- **Podcast segments — structured dialogue UI and backend sync**: Keep podcast content in sync between the user interface and backend.
- **Add webhook notification delivery for published podcast audio**: Receive instant alerts when new podcast episodes are available.
- **Add dynamic poll option add/remove controls in WhatsApp editor**: Easily manage poll options within WhatsApp messages.
- **Generate audio preview for highlighted text segment**: Listen to a quick audio preview of selected text for better content review.
