...
- We fixed an issue to ensure WhatsApp messages are not sent more than once.
...
- We added a new user ID feature that allows more flexibility in user identification.
- You can now use Hanko for secure login and connect user accounts easily.
- Our platform now supports Hanko authentication, making it easier to validate users and link accounts.
- We improved backend processes to keep user identities in sync with Hanko.
- Admins can now use new tools for managing and migrating user accounts.
- We introduced new email templates for user ID updates and dual authentication.
- We enhanced the connection between different parts of the platform for better data management.
- You can now add static images to events for a richer experience.
- We improved data synchronization to ensure strategies are built with the latest information.

**Improvements**

- We enhanced error tracking to better understand and resolve issues.

**Bug Fixes & Stability**

- We fixed the audio preview feature to work correctly with its specific version.

**Other Changes**

- We updated our development tools for better performance and security.
- We made improvements to our infrastructure for smoother operations.
...
- You can now enjoy a more organized podcast interface with synchronized backend updates.
- We added notifications to keep you informed when new podcast audio is published.
- You can now easily add or remove poll options in WhatsApp.
- We introduced a feature to create audio previews from selected text segments.
