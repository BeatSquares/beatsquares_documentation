...
- We fixed an issue that prevented WhatsApp messages from being sent more than once by mistake.
...
- We added a new ID for users that can be left blank, ensuring each user has a unique identifier.
- You can now use Hanko for secure login and connect it with your user account.
- Our app now supports Hanko authentication, making login and user connection smoother.
- We improved backend processes to keep your identity secure and synced with Hanko.
- Admins can now manage users more efficiently with new tools for Hanko integration.
- We updated email templates to support new user IDs and authentication methods.
- We improved how different parts of our app connect, ensuring everything works together seamlessly.
- You can now add static images to events, making them more visually appealing.
- We enhanced data syncing to ensure your choices are reflected accurately in strategies.

**Improvements**

- We improved error tracking by linking Sentry and LangSmith, making it easier to find and fix issues.
...
- We improved our infrastructure with better scripts and password security.
...
- We streamlined podcast management by using a single, reliable source for all podcast data.
- Our new interface makes it easier to manage podcast segments and keeps everything in sync.
- You will now receive notifications when your podcast audio is published.
- You can easily add or remove poll options in WhatsApp, giving you more control.
- We added a feature to create audio previews from selected text, enhancing your content.
