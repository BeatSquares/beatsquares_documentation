...
<Update label="Version 1.2.4 - Improvements" description="Released April 21, 2026">

**Improvements**

- **Apply blueprint formatting_template in WhatsApp auto-suggestions**: WhatsApp suggestions now look more organized and easier to read.

**Bug Fixes & Stability**

- Fixed an issue where the system could slow down due to too many connections.
- Resolved an error that occurred when creating a podcast with no mood selected.
- Fixed a problem where the audio briefing screen would freeze during generation errors.

</Update>

<Update label="Version 1.2.3 - Bug Fixes" description="Released April 1, 2026">

**Bug Fixes & Stability**

- Fixed issues with press release updates for Dachau and Landkreis Dachau.

</Update>

<Update label="Version 1.2.2 - Bug Fixes" description="Released March 13, 2026">

**Bug Fixes & Stability**

- Resolved a mismatch issue for WhatsApp messages related to events and press releases.
- Fixed timing issues with WhatsApp article suggestions to improve task management.
- Improved accuracy and reliability for verification processes and updates.
- Fixed a flickering issue in the media interface and addressed text-to-speech errors.
- Ensured content types are correctly saved for better article management.
- Resolved an error during media creation to ensure smoother operations.
- Fixed a timeout issue during long podcast generation for a better experience.

</Update>

<Update label="Version 1.2.1 - Improvements" description="Released February 12, 2026">

**Improvements**

- **Disable WhatsApp article suggestions and metadata processing for SHZ RSS handler**: Streamlined the SHZ RSS feed by removing unnecessary suggestions.

**Bug Fixes & Stability**

- Improved e-paper signal filtering for better customization.
- Fixed a timeout issue during audio preview generation in podcasts.
