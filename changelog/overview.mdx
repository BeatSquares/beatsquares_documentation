...
- We fixed an issue to make the curation tool more reliable by simplifying its output and ensuring it works smoothly even if some data isn't perfectly formatted.
