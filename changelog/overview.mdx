...
- **Podcast segments — structured dialogue UI and backend sync**  
  Easily manage podcast segments with a user-friendly interface that keeps everything in sync.

- **Add webhook notification delivery for published podcast audio**  
  Get instant notifications when your podcast episodes go live.

- **Add dynamic poll option add/remove controls in WhatsApp editor**  
  Effortlessly add or remove poll options in your WhatsApp messages.

- **Generate audio preview for highlighted text segment**  
  Quickly listen to a preview of any highlighted text in your audio files.
