...
- We fixed issues that caused errors when saving data and displaying dates, ensuring smoother performance.
...
- **Migrate podcast dialog to structured_data as the single source of truth**: We streamlined how podcast information is stored, making it more reliable and consistent.
- **Podcast segments — structured dialogue UI and backend sync**: Enjoy a more organized podcast editing experience with better alignment between what you see and what's saved.
- **Add webhook notification delivery for published podcast audio**: Get instant notifications when your podcast is published, keeping you updated in real-time.
- **Add dynamic poll option add/remove controls in WhatsApp editor**: Easily add or remove poll options while chatting on WhatsApp, giving you more flexibility.
- **Generate audio preview for highlighted text segment**: Listen to a quick audio preview of any selected text, making it easier to review content.
