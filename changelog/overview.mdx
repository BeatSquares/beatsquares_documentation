...
- **Migrate podcast dialog to structured_data as the single source of truth**: Enjoy a more reliable and consistent podcast experience with improved data management.
- **Podcast segments — structured dialogue UI and backend sync**: Easily organize and sync your podcast segments for a smoother workflow.
- **Add webhook notification delivery for published podcast audio**: Get instant updates when your podcast episodes go live.
- **Add dynamic poll option add/remove controls in WhatsApp editor**: Effortlessly manage poll options in your WhatsApp messages.
- **Generate audio preview for highlighted text segment**: Quickly listen to audio previews of selected text to ensure it sounds just right.
