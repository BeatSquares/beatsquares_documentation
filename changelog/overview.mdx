...
- **Migrate podcast dialog to structured_data as the single source of truth**  
  We’ve improved how podcast information is organized, making it more reliable and consistent.

- **Podcast segments — structured dialogue UI and backend sync**  
  Enjoy a smoother experience with podcast segments that now update seamlessly between the app and server.

- **Add webhook notification delivery for published podcast audio**  
  Get instant notifications when your podcast audio is published, keeping you in the loop.

- **Add dynamic poll option add/remove controls in WhatsApp editor**  
  Easily add or remove poll options in WhatsApp, giving you more flexibility in your conversations.

- **Generate audio preview for highlighted text segment**  
  Listen to a quick audio preview of any highlighted text, helping you decide if it sounds just right.
