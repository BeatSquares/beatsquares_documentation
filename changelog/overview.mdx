...
- We fixed issues that caused errors when saving data and improved how dates and times are handled, ensuring smoother performance.
...
- **Migrate podcast dialog to structured_data as the single source of truth**: We streamlined podcast management by centralizing information, making it easier to keep everything consistent.
- **Podcast segments — structured dialogue UI and backend sync**: Enjoy a more organized podcast editing experience with synchronized updates between the interface and the system.
- **Add webhook notification delivery for published podcast audio**: Get instant alerts when your podcast episodes go live, keeping you informed in real-time.
- **Add dynamic poll option add/remove controls in WhatsApp editor**: Easily customize polls in WhatsApp by adding or removing options with just a click.
- **Generate audio preview for highlighted text segment**: Quickly listen to a preview of selected text, helping you review audio content more efficiently.
