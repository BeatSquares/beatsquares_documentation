...
- **Podcast segments — structured dialogue UI and backend sync**  
  Experience seamless podcast segment management with synchronized updates.
...
- **Add dynamic poll option add/remove controls in WhatsApp editor**  
  Easily customize your WhatsApp polls by adding or removing options on the fly.

- **Generate audio preview for highlighted text segment**  
  Quickly listen to a preview of any highlighted text in your audio projects.
