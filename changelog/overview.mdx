...
- **Migrate podcast dialog to structured_data as the single source of truth**  
  We’ve improved how podcast information is stored, making it more reliable and consistent.

- **Podcast segments — structured dialogue UI and backend sync**  
  Enjoy a smoother experience with podcast segments that now sync seamlessly between what you see and what’s saved.

- **Add webhook notification delivery for published podcast audio**  
  Get instant notifications when your podcast audio is published, keeping you updated in real-time.

- **Add dynamic poll option add/remove controls in WhatsApp editor**  
  Easily add or remove poll options while editing in WhatsApp, giving you more flexibility.

- **Generate audio preview for highlighted text segment**  
  Listen to a quick audio preview of any text you highlight, helping you decide if it sounds just right.
