...
- We fixed an issue to ensure that WhatsApp messages are not sent more than once.
...
- We added a new user ID field that can be left blank but must be unique.
- You can now use Hanko for two-step authentication and linking user accounts.
- Our system now supports Hanko authentication, making it easier to log in and connect accounts.
- We improved how user identities are managed and verified in the backend.
- Admins can now use new tools for managing users and migrating data in bulk.
- We updated email templates to support new user IDs and dual authentication.
- We improved how different parts of the system connect and share information.
- You can now add static images to events for a better visual experience.
- We enhanced data syncing to ensure strategies are built with the latest information.

**Improvements**

- We improved error tracking to provide better insights into system performance.

**Bug Fixes & Stability**

- We fixed an issue to ensure audio previews play correctly for the right version.

**Other Changes**

- We updated our processes to use the latest tools and fixed some technical issues.
...
- We improved podcast management by centralizing data for consistent updates.
- You can now enjoy a more organized interface and better data syncing for podcasts.
- We added notifications to alert you when podcast audio is published.
- You can now easily add or remove poll options in the WhatsApp editor.
- You can generate audio previews for selected text to enhance your content.
