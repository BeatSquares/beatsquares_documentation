...
<Update label="Version 1.32.0 - Generate and store LinkedIn carouse..." description="Released June 22, 2026">
...
- **Disable WAHA NOWEB chat store**: Ensure WhatsApp messages are delivered by checking the preview feed.
...
<Update label="Version 1.31.0 - Migrate podcast dialog to structure..." description="Released May 6, 2026">

**New Features**

- **Migrate podcast dialog to structured_data**: Podcast dialogues are now more organized and reliable with structured data.
- **Podcast segments**: Enjoy a more interactive podcast experience with a new dialogue interface and synchronized backend.
- **Add webhook notification delivery for published podcast audio**: Get instant notifications when your podcast audio is published.
- **Add dynamic poll option controls in WhatsApp editor**: Easily add or remove poll options while editing in WhatsApp.
- **Generate audio preview for highlighted text segment**: Quickly preview audio for selected text segments to ensure accuracy.
