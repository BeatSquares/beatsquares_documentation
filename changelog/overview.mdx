...
- We added a new user ID field to enhance user identification.
- You can now use dual authentication for better security and link users more easily.
- We improved the login process with new authentication features and user linking.
- The system now synchronizes user identities more efficiently in the background.
- Admins can now manage users more effectively with new tools for user migration.
- We introduced new email templates for user authentication and communication.
- There's now a clear connection between different sections of your account.
- You can now add images to events for a more engaging experience.
- We improved data handling to make strategy building more straightforward.
...
- The audio preview now works correctly for the specific version it was created for.

**Other Changes**

- We updated our systems to use the latest tools for better performance.
- We made improvements to our infrastructure for better security and efficiency.
...
- We streamlined podcast management by centralizing data handling.
- Podcast creation is now easier with a new user interface and better data syncing.
- You will receive notifications when your podcast audio is published.
- You can now easily add or remove poll options in WhatsApp messages.
- Highlighted text segments can now generate audio previews for a better experience.
