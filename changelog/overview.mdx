...
<Update label="Version 1.30.0 - Declarative structured newsletter t..." description="Released June 15, 2026">
...
- **Zernio/LinkedIn connection settings** — Manage LinkedIn connections at both organization and group levels.
- **Hook LinkedIn media-item type into the frontend create flow** — Seamlessly integrate LinkedIn content into your creation process.
- **Pexels image search for newsletter segments** — Find and add high-quality images to your newsletters effortlessly.
...
- **Adapt curation agent to Kraushaar** — Improve content curation with better handling of diverse content types.
...
- Keep Civey poll links intact — Ensure poll links work correctly when imported.
...
- Update deployment process to use ECS — Improve deployment efficiency with a new workflow.
...
- **WordPress REST API article importer for Ruhrnachrichten** — Easily bring in articles from WordPress for streamlined content management.
- **Add "quiz" content type** — Create and manage quizzes for engaging newsletter content.
- **LinkedIn output via Zernio** — Set up the foundation for sharing content on LinkedIn.
...
- **Send a bilingual welcome email** — Welcome new users with emails in multiple languages.
...
- **Introduce CONTENT_TYPE_REGISTRY** — Streamline content management with a new system.
- **Add content_type routing to the RSS_FEED pipeline** — Improve content delivery with efficient routing.
- **Redesign bilingual welcome email** — Enhance the welcome experience with improved design and messaging.
