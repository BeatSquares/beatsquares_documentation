...
<Update label="Version X.X.X - Release" description="Released April 21, 2026">

**Improvements**
- **WhatsApp Auto-Suggestions**: Auto-suggested WhatsApp content now follows your blueprint formatting template for more consistent message layouts
