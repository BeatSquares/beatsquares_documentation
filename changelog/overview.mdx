...
- **Email article cleanup and LLM model upgrade to GPT-5**: Improves email article quality with the latest AI model.
- **Integrate E2E test suite with Playwright into the monorepo**: Enhances testing reliability by integrating comprehensive tests.
- **Split LLM prompts into system and user messages**: Improves clarity by separating system and user prompts.

**Bug Fixes & Stability**

- Fixes issues with Kreis Freising and Wolfratshausen press release processing.
...
<Update label="Version 1.19.0 - Unify action status, optimistic upd..." description="Released April 13, 2026">

**New Features**

- **Unify action status, optimistic updates, and Redis-driven cache invalidation**: Streamlines updates and improves performance.
- **Persist script generation and publish snapshots for segment analytics**: Keeps track of script changes for better analytics.
...
- **Route articles to multiple Squares via sekundaereFachinfoDienste**: Distributes articles across different platforms efficiently.
- **Add images to WhatsApp RSS feed via enclosure**: Enhances WhatsApp feeds with image support.
- **Show fact viewer for WhatsApp segments via unified source content sidebar**: Displays additional information for WhatsApp content.
- **Parse titelIntern for interview keyword and set metadata.type tag**: Automatically tags content based on keywords.
...
<Update label="Version 1.18.0 - Define content source configuration..." description="Released April 7, 2026">
...
<Update label="Version 1.17.0 - Add retry logic for transient" description="Released March 30, 2026">
...
- **Switch Contentful webhook filter from status to audiobriefingReady field**: Enhances webhook filtering for better accuracy.
...
<Update label="Version 1.15.0 - Add CurationConfig to squares with" description="Released March 18, 2026">
...
- **Switch Contentful webhook filter from status to audiobriefingReady**: Improves webhook filtering for better accuracy.

</Update>

<Update label="Version 1.14.0 - Add button to create empty" description="Released March 16, 2026">
...
- **Extract Berlin district (Bezirk) metadata from Tagesspiegel**: Automatically gathers location data for better organization.
...
- Ensures Contentful content types are correctly saved to metadata for better data management.

</Update>

<Update label="Version 1.13.0 - Set up pre-commit hooks with" description="Released March 11, 2026">

**New Features**

- **Set up pre-commit hooks with ruff for automatic code formatting**: Keeps code clean and consistent automatically.
- **Standardize timezone handling in scheduled generation to UTC and update related tests**: Ensures consistent scheduling by using a standard time zone.
- **Standardize timezone handling in scheduled generation to UTC and fix schedule recalculation**: Improves scheduling accuracy with standardized time zones.
- **[BEA-2223] Slack notifications and auto-generation for articles**: Keeps you informed with automatic notifications and article generation.
...
- Restricts MongoDB access and improves deployment processes for better security and efficiency.
...
- **Add LLM-based article facet classification for SHZ data sources**: Enhances article categorization with AI.
- **Add playback speed control to segment preview**: Lets you adjust playback speed for better control.

</Update>

<Update label="Version 1.11.0 - Segment generation UX with progress" description="Released March 2, 2026">
...
- **Increase strategy timeouts from 5 to 10 minutes across ALB, Nginx, and Strategy Builder**: Allows more time for complex strategies to complete.
...
<Update label="Version 1.10.0 - Add configurable Tiptap editor styl..." description="Released February 24, 2026">

**New Features**

- **Add configurable Tiptap editor styles and custom buttons to square settings**: Customizes the editor to fit your needs.
...
- **Optimize GitHub Actions CI/CD pipeline**: Speeds up development processes with optimized workflows.
- **Remove unused dependencies**: Cleans up the system for better performance.

</Update>

<Update label="Version 1.9.0 - Add unified segment editing compone..." description="Released February 17, 2026">
...
<Update label="Version 1.8.0 - Enable WhatsApp cross-posting and s..." description="Released February 16, 2026">
...
- **Link LangSmith traces between BeatSquares and strategies service**: Enhances traceability and strategy alignment.
...
- Fixes deprecation warnings by updating dependencies.
...
- **Enable automatic WhatsApp suggestions for SHZ articles with blueprint strategy support**: Improves content suggestions with automated strategies.
...
<Update label="Version 1.6.0 - Migrate to cookie-based authenticat..." description="Released February 2, 2026">

**New Features**

- **Migrate to cookie-based authentication**: Simplifies login processes with cookies.
- **Implement Contentful webhook integration for Tagesspiegel background articles**: Enhances content integration with webhooks.
- **Use short URLs for SZ WhatsApp posts**: Makes sharing easier with shorter links.
- **Implement extensible article display title combining kicker and title for Tagesspiegel**: Improves article title presentation.
...
<Update label="Version 1.5.0 - Implement Signal Provider Architect..." description="Released January 27, 2026">
...
- **, BEA-1576] Add S3 importer for e-paper XML and analytics data**: Improves data import capabilities.
...
- **Add new Nugget data sources with HybridRssSpider implementations**: Expands data source options.
- **Add new RSS spiders for various regions in Schleswig-Holstein**: Enhances regional content coverage.
- **Refactor Segment Action Controls into single logic source**: Simplifies action control management.
- **Make bezirke strategies resilient to different input JSON formats**: Ensures strategy robustness.
...
<Update label="Version 1.4.0 - Implement unified content model for" description="Released January 23, 2026">

**New Features**

- **Implement unified content model for strategy inputs**: Standardizes content input for better strategy management.

**Improvements**

- **Cherry-pick bezirke strategies commits to staging**: Ensures the latest strategy updates are tested and ready.

</Update>

<Update label="Version 1.3.0 - Bug Fixes" description="Released January 20, 2026">
...
<Update label="Version 1.2.0 - S3 Imports & Editor Polish" description="Released January 27, 2026">
...
<Update label="Version 1.1.1 - Unified Content Model" description="Released January 23, 2026">
