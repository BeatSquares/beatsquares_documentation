...
- We fixed an issue to ensure you don't receive duplicate WhatsApp messages.
...
- We added a new user ID option to improve user account management.
- You can now use dual authentication for better security when logging in and linking accounts.
- Our system now supports enhanced authentication, making login and user verification smoother.
- We improved how we handle user identity and verification in the backend.
- Admins can now manage user accounts more efficiently and migrate users in bulk.
- We introduced new email templates for user ID updates and dual authentication.
- We improved how different parts of the app connect for a more seamless experience.
- You can now add static images to events for better visual representation.
- We enhanced data synchronization to make strategy building easier and more effective.

**Improvements**

- We improved error tracking to help us fix issues faster.

**Bug Fixes & Stability**

- We fixed the audio preview player so it only plays for the correct version.

**Other Changes**

- We updated our development tools for better performance.
- We made some technical updates to improve system security and efficiency.
...
- We updated the podcast feature to use a more reliable data structure.
- The podcast interface is now more organized, and changes sync automatically.
- You will now receive notifications when your podcast audio is published.
- You can easily add or remove poll options in WhatsApp messages.
- You can generate a preview of audio for selected text segments.
