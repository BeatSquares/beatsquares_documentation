...
**Improvements**
- **SHZ RSS Handler**: Stop processing WhatsApp article suggestions and metadata to streamline your experience.

**Bug Fixes & Stability**
- Fix audio preview generation in podcast segments to prevent timeouts and ensure smooth playback.
